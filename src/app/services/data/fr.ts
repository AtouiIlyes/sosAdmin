export const fr = {
  fr: {
    ...
    "dxDateBox-validation-datetime":
      "La valeur doit être une date ou une heure.",
    ...
    "dxDataGrid-columnChooserEmptyText":
      "Faites glisser une colonne ici pour la cacher",
    ...
    "dxScheduler-confirmRecurrenceEditMessage":
      "Voulez-vous éditer cet évenement ou la série entière ?",
    "dxScheduler-confirmRecurrenceDeleteMessage":
      "Voulez-vous supprimer cet évenement ou la série entière ?",
